                            ...
                            <div class="d-flex justify-content-center align-items-center container">
                                ...
                                <center>
                                    ...
                                    <span class="mobile-text">
                                        ...
                                        <b class="text-danger">+91 <?php echo $this->session->userdata("tel_no") ?></b>
                                    </span>
                                    <form method="post" action="<?php echo base_url(); ?>check_mobile">
                                        <div class="mb-3 mt-3">
                                            <input type="number" max="999999" min="100000" class="form-control" autofocus="" name="otp_data" placeholder="Enter Your OTP" required>
                                        </div>
                                        <div class="mb-3">
